  ...
  return (
    <div className="flex h-[calc(100dvh-var(--shell-header-h))] min-h-0 flex-col" data-testid="chat-panel">
      <div className="flex min-h-0 flex-1 flex-col overflow-y-auto px-4 md:px-6" data-testid="messages">
        {messages.length > 0 && (
          <div className="sticky top-0 z-10 -mx-4 border-b border-border/70 bg-bg/85 px-4 backdrop-blur md:-mx-6 md:px-6">
            <div className="mx-auto flex w-full max-w-[760px] items-center gap-3 py-2">
        ...
        {messages.length === 0 && (
          <div className="flex flex-1 flex-col items-center justify-center pb-[12vh] pt-6 text-center" data-testid="mentor-intro">
            ...
            <h1 className="-mt-10 font-display text-[2.25rem] font-medium leading-none tracking-[-0.015em] text-fg [text-wrap:balance]">Tesleem Fowora</h1>
