// Seed 00 — the three e2e users (docs/loops/CONTRACTS.md). Idempotent: finds by email, creates
// if missing, then upserts the profile role (and a mentors row for the mentor).
